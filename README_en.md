...
| [Installation](docs/installation_en.md) | One-command install with npx, the official `dsh plugin` channel for the config UI, prerequisites, the six wizard stages, CLI flags, host patch detection, applying/upgrading/uninstalling, mounting the config UI, troubleshooting. |
