 ...
 * 损坏块拒绝写盘）、detectPresetSystem 降级链（runtimeSystem 直通 / dsh
 * --version 不可执行时按单数包存在性探测）、generateAndInstall 双轨集成冒烟
 *（declarative 落盘三件套 + home patch 托管块；directory 撤残留声明块自愈）。
 */
